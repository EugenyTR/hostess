...
export default function EditNomenclatureModal({ isOpen, onClose, onSave, item }: EditNomenclatureModalProps) {
  const [formData, setFormData] = useState<NomenclatureItem>(item)
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold text-gray-900">Редактировать номенклатуру</h2>
