...
export default function DeleteColorModal({ isOpen, onClose, onConfirm, colorName }: DeleteColorModalProps) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
        ...
        <div className="text-center mb-6">
          <h2 className="text-lg font-medium text-[#2c2c33] mb-2">Вы уверены, что хотите удалить цвет?</h2>
          <p className="text-[#7f8189]">Цвет "{colorName}" будет удален безвозвратно.</p>
        </div>
