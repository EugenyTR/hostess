...
type TabType = "clients" | "rfm" | "history"
...
export default function ClientsList() {
  ...
  // Функция экспорта клиентов в Excel
  const handleExportToExcel = () => {
    try {
      ...
      console.log(`Экспортировано ${exportData.length} клиентов в CSV файл`)
    } catch (error) {
  ...
  // Получаем уникальные города из клиент��в
