...
export default function CreateWarehousePage() {
  ...
  const { addWarehouse, cities, contractors } = useAppContext()
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    ...
    setFormData((prev) => ({
      ...prev,
      [name]: name === "cityId" || name === "contractorId" ? Number.parseInt(value) || "" : value,
    }))
  ...
  return (
    <div className="p-6">
      <div className="flex items-center gap-4 mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Создать склад</h1>
      </div>
