              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                {paginatedItems.map((item) => (
                    <tr key={item.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-3 py-2 whitespace-nowrap text-sm text-gray-900">{item.article}</td>
                      <td className="px-3 py-2 whitespace-nowrap text-sm text-gray-900">{item.basePrice} ₽</td>
                      <td className="px-3 py-2 whitespace-nowrap text-sm text-gray-900">{item.markup}%</td>
                      <td className="px-3 py-2 whitespace-nowrap text-sm text-gray-900">{item.finalPrice} ₽</td>
                      <td className="px-3 py-2 whitespace-nowrap text-sm text-gray-900">{item.warehouse}</td>
                      <td className="px-3 py-2 whitespace-nowrap text-sm text-gray-900">{item.defaultQuantity}</td>
